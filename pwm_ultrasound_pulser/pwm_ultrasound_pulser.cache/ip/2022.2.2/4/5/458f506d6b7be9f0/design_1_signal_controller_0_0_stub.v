...
/* synthesis syn_black_box black_box_pad_pin="n_reset_i,clk_i,start_delay_i[5:0],train_length_i[15:0],gate_delay_i[15:0],prime_i,fire_i,prf_o,enable_o,pulse_o,gate_o,leds_o[3:0]" */;
  input n_reset_i;
  input clk_i;
